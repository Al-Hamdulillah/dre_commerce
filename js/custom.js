$(function () {
	...
	$('.faq_inner a.one_btn').click(function () {
		$('.faq_inner a.one_btn .hide').toggle();
	});

	$('.faq_inner a.one_btn').click(function () {
		$('.faq_inner a.one_btn .show').toggle();
	});



	$('.faq_inner a.two_btn').click(function () {
		$('.faq_inner a.two_btn .hide').toggle();
	});

	$('.faq_inner a.two_btn').click(function () {
		$('.faq_inner a.two_btn .show').toggle();
	});


	$('.faq_inner a.three_btn').click(function () {
		$('.faq_inner a.three_btn .hide').toggle();
	});

	$('.faq_inner a.three_btn').click(function () {
		$('.faq_inner a.three_btn .show').toggle();
	});



	$('.faq_inner a.four_btn').click(function () {
		$('.faq_inner a.four_btn .hide').toggle();
	});

	$('.faq_inner a.four_btn').click(function () {
		$('.faq_inner a.four_btn .show').toggle();
	});



	$('.faq_inner a.five_btn').click(function () {
		$('.faq_inner a.five_btn .hide').toggle();
	});

	$('.faq_inner a.five_btn').click(function () {
		$('.faq_inner a.five_btn .show').toggle();
	});


	$('.faq_inner a.six_btn').click(function () {
		$('.faq_inner a.six_btn .hide').toggle();
	});

	$('.faq_inner a.six_btn').click(function () {
		$('.faq_inner a.six_btn .show').toggle();
	});
	...
	//	var containerEl = document.querySelector('.product_list_view');
	//
